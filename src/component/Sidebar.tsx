        ...
        <div className="drawer-side">
            ...
            <ul className="menu p-4 w-72 min-h-full bg-gray-50 text-base-content">
                ...
                <li className={`${isActive == "allTasks" ? "bg-gray-200 text-black" :"text-gray-500"} mb-2`}>
                    <a href="/dashboard"><i className="text-xs text-blue-400 fas fa-circle mr-3"></i> Uncategorized</a>
                </li>

                <li className={`${isActive == "today" ? "bg-gray-200 text-black" :"text-gray-500"} mb-2`}>
                    <a href="/dashboard?filter=today"><i className="text-xs text-yellow-400 fas fa-circle mr-3"></i> Today</a>
                </li>
